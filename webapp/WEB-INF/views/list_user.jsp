																...
																<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
																	...
																	<div class="fv-row mb-7">
																		...
																		<div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('media/svg/avatars/blank.svg')">
																			...
																			<div class="image-input-wrapper w-125px h-125px" style="background-image: url(media/avatars/300-6.jpg);"></div>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
											...
											<thead>
												...
												<tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-90px">이름/ID</th>
													<th class="min-w-90px">사번</th>
													<th class="min-w-125px">직책</th>
													<th class="min-w-125px">연락처1</th>
													<th class="min-w-125px">연락처2</th>
													<th class="min-w-125px">가입일시</th>
												...
												<tr>
													...
													<td class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<a href="../../demo1/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">${ user.USER_NAME }</a>
															<span>${ user.USER_ID }</span>
														</div>
														<!--begin::User details-->
													</td>
													<td>${ user.USER_EMP_NUM }</td>
													<!--end::User=-->
													<!--begin::Role=-->
													...
													<!--begin::Last login=-->
													<td>
														<span>${ user.USER_TEL1 }</span>
													</td>
													<!--end::Last login=-->
													<!--begin::Two step=-->
													<td>${ user.USER_TEL2 }</td>
													<!--end::Two step=-->
													<!--begin::Joined-->
